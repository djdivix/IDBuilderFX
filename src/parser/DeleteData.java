...
public static String deleteLines(String txt)
{
	...
	String text1="",text2="";
	int i=0,j=0;
	String[] heading = { "mobile", "phone", "email", "an overview", "work experience",
			"academic credentials", "education", "technical skills", "highlights", "achievements",
			"area of interest", "personal dossier", "date of birth", "address", "linguistic abilities",
			"declaration", "additional details", "qualification", "skills", "enrollment number" };
	for(i=0;i<len;i++)
	{
...
/*	flag=0;
	for(j=len-1;j>i;j--)
	{
		for(String tempHead:heading)
		{
			...
			{
				System.out.println(lines[j]+"__________");
				flag=1;
				break;
			}
		}
